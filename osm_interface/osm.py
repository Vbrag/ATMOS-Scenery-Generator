...
#
# Generated Sat Oct 28 10:39:11 2023 by generateDS.py version 2.43.2.
...
#
# Command line:
#   C:\Users\abdelmaw\AppData\Local\Programs\Python\Python311\Scripts\generateDS.py -o "osm_interface.py" osm_interface.xsd
#
...
class osm(GeneratedsSuper):
    ...
    def set_way(self, way):
        self.way = way
    def add_way(self, value):
        self.way.append(value)
    def insert_way_at(self, index, value):
        self.way.insert(index, value)
    def replace_way_at(self, index, value):
        self.way[index] = value
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="" ', name_='osm_interface', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('osm_interface')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'osm_interface':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='osm_interface')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='osm_interface', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='osm_interface'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="" ', name_='osm_interface', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class NewDataSet(GeneratedsSuper):
    ...
    def get_osm(self):
        return self.osm
    def set_osm(self, osm):
        self.osm = osm
    def add_osm(self, value):
        self.osm.append(value)
    def insert_osm_at(self, index, value):
        self.osm.insert(index, value)
    def replace_osm_at(self, index, value):
        self.osm[index] = value
    def has__content(self):
        if (
            self.tag or
            self.osm
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="" ', name_='NewDataSet', fromsubclass_=False, pretty_print=True):
        ...
        for osm_ in self.osm:
            ...
            osm_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='osm_interface', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'osm_interface':
            obj_ = osm.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.osm.append(obj_)
            obj_.original_tagname_ = 'osm_interface'
...
class metaType(GeneratedsSuper):
    ...
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_osm_base(self):
        return self.osm_base
    def set_osm_base(self, osm_base):
        self.osm_base = osm_base
    def has__content(self):
        if (
...
class boundsType(GeneratedsSuper):
    ...
    def get_minlat(self):
        return self.minlat
    def set_minlat(self, minlat):
        self.minlat = minlat
    def get_minlon(self):
        return self.minlon
    def set_minlon(self, minlon):
        self.minlon = minlon
    def get_maxlat(self):
        return self.maxlat
    def set_maxlat(self, maxlat):
        self.maxlat = maxlat
    def get_maxlon(self):
        return self.maxlon
    def set_maxlon(self, maxlon):
        self.maxlon = maxlon
    def has__content(self):
        if (
...
class wayType(GeneratedsSuper):
    ...
    def set_nd(self, nd):
        self.nd = nd
    def add_nd(self, value):
        self.nd.append(value)
    def insert_nd_at(self, index, value):
        self.nd.insert(index, value)
    def replace_nd_at(self, index, value):
        self.nd[index] = value
    def get_tag(self):
        return self.tag
    def set_tag(self, tag):
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from osm_interface import *\n\n')
        sys.stdout.write('import osm_interface as model_\n\n')
...
if __name__ == '__main__':
    ...
    map =  parse("map_osm.xml",  silence=True )
